...
<nav class="navbar navbar-expand-lg bg-body-tertiary text-white bg-dark ms-auto">
  <div class="container-fluid">
    <a class="navbar-brand text-white h4" style="text-transform: uppercase;" href="#">Travego <svg xmlns="http://www.w3.org/2000/svg" width="30" height="50" fill="currentColor" class="bi bi-airplane" viewBox="0 0 16 16">
