...
?>
<div class="konten">
<div class="row mx-auto p-5 rounded" style="width: 700px; background-color: #33334c; margin-top: 10%;">
<h2 class="text-center text-white">TRAVEGO</h2>
  <div class="col text-white">
    ...
    ?>
  <form action="4gotpasswordaction.php" method="post">
    ...
    <br>
    <button type="submit" name="forgotpass" class="btn btn-primary">sign in</button><br>
</form>
